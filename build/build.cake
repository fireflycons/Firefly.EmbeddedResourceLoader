...
var solutionFile = File("../Firefly.EmbeddedResourceLoader.sln");
var documentationWebFolder = "Firefly-EmbeddedResourceLoader";
...
Task("CopyDocumentationTo-github.io-clone")
    ...
    .Does(() => {
        ...
        var outputDir = MakeAbsolute(Directory(System.IO.Path.Combine(EnvironmentVariableStrict("APPVEYOR_BUILD_FOLDER"), "..", "fireflycons.github.io", documentationWebFolder)));
